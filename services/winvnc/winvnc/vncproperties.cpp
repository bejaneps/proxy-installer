...
vncProperties::LoadUserPrefs(HKEY appkey)
{
	...
	//@http@ m_pref_HTTPConnect=LoadInt(appkey, "HTTPConnect", m_pref_HTTPConnect);
...
vncProperties::ApplyUserPrefs()
{
	...
	//@http@ m_server->EnableHTTPConnect(m_pref_HTTPConnect);
...
vncProperties::SaveUserPrefs(HKEY appkey)
{
	...
	//@http@ SaveInt(appkey, "HTTPConnect", m_server->HTTPConnectEnabled());
...
void vncProperties::LoadFromIniFile()
{
	...
	//@tray@ m_server->SetDisableTrayIcon(myIniFile.ReadInt("admin", "DisableTrayIcon", false))
...
void vncProperties::LoadUserPrefsFromIniFile()
{
	...
	//@http@ m_pref_HTTPConnect=myIniFile.ReadInt("admin", "HTTPConnect", m_pref_HTTPConnect);
...
void vncProperties::SaveUserPrefsToIniFile()
{
	...
	// @http@ myIniFile.WriteInt("admin", "HTTPConnect", m_server->HTTPConnectEnabled());
