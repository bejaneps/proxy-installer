...
//@http@ LONG HTTPConnect;
LONG AutoPortSelect=1;
// LONG PortNumber;
//@http@ LONG HttpPortNumber;
LONG IdleTimeout;
...
//@tray@ DisableTrayIcon=myIniFile_In.ReadInt("admin", "DisableTrayIcon", false);
...
//@tray@ myIniFile_Out.WriteInt("admin", "DisableTrayIcon", DisableTrayIcon);
...
//@http@ HTTPConnect=myIniFile_In.ReadInt("admin", "HTTPConnect", true);
AutoPortSelect=myIniFile_In.ReadInt("admin", "AutoPortSelect", true);
// PortNumber=myIniFile_In.ReadInt("admin", "PortNumber", 0);
//@http@ HttpPortNumber=myIniFile_In.ReadInt("admin", "HTTPPortNumber",0);
...
//@http@ myIniFile_Out.WriteInt("admin", "HTTPConnect", HTTPConnect);
myIniFile_Out.WriteInt("admin", "AutoPortSelect", AutoPortSelect);
// myIniFile_Out.WriteInt("admin", "PortNumber", PortNumber);
//@http@ myIniFile_Out.WriteInt("admin", "HTTPPortNumber", HttpPortNumber);
