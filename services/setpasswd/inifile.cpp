...
{
	return GetPrivateProfileStruct("PASSWORD","passwd",value,8,myInifile);
}

bool
IniFile::WritePassword(char *value)
{
		return (FALSE != WritePrivateProfileStruct("PASSWORD","passwd", value,8,myInifile));
}

bool//PGM
IniFile::ReadPassword2(char *value,int valuesize) //PGM
{ //PGM
	return GetPrivateProfileStruct("PASSWORD","passwd2",value,8,myInifile); //PGM
} //PGM

bool //PGM
IniFile::WritePassword2(char *value) //PGM
{ //PGM
		return (FALSE != WritePrivateProfileStruct("PASSWORD","passwd2", value,8,myInifile)); //PGM
} //PGM
