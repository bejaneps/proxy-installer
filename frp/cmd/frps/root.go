...
import (
	...
	"github.com/bejaneps/frp/server"
...
func init() {
	rootCmd.PersistentFlags().StringVarP(&cfgFile, "config", "c", "", "config file of rsa")
	rootCmd.PersistentFlags().BoolVarP(&showVersion, "version", "v", false, "version of rsa")
...
var rootCmd = &cobra.Command{
	Use:   "rsa",
	Short: "rsa is the server of ServiceTree.",
