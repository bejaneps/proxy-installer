...
// AuthUser sends a username & password to auth server.If success it returns a ports mapping, else error.
func AuthUser(username, password, authURL string) (data msg.AuthResp, err error) {
